...
def main():
    ...
    for i in range(len(kv)):
        ...
        # all we need
        key_boxes, value_boxes, key_words, value_words = vals

        # make the folder if doesnt exist
        ...
        value_str = " ".join(value_words)
        print(key_str)
        print(value_str)
        print("----")

    img.save("output/whole.jpeg", format="JPEG")
    # img.show()
